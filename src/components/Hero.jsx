  ...
  return (
    <div className="w-full h-screen flex flex-col justify-center items-center isolate relative z-10">
      ...
      <div className="flex flex-col md:items-center items-start xl:gap-y-10 gap-y-3 xl:mb-0 md:mb-20 mb-0">
        <h1 className="flex felx-col xl:space-y-8 md:space-y-4 space-y-2 xl:text-6xl md:text-4xl text-3xl md:font-normal font-bolder mt-8 md:mt-0">
          ...
          <span className="xl:text-6xl md:text-4xl text-2xl tracking-wider xl:py-4 py-2 overflow-hidden">
            I'm
            <span
              className={`inline-block xl:w-[380px] md:w-[240px] w-[160px] lg:ml-6 ml-2 font-extrabold transform origin-left transition-transform duration-300 ease-in-out ${
        ...
        <button
          className="xl:w-[400px] md:w-[300px] w-[270px] bg-gray-900  dark:bg-gray-200 md:py-1 py-0 md:px-4 px-2 xl:text-2xl md:text-xl text-base text-white             dark:text-gray-900 tracking-widest flex justify-between items-center md:mr-auto md:mx-0 mx:auto rounded-r-3xl transition-colors duration-500 "
          onClick={() => {
            setIsTextVisibile(!isTextVisible);
          }}
          onMouseEnter={() => {
            setRoadImageOpacity(0.9);
          }}
          onMouseLeave={() => {
            setRoadImageOpacity(0.4);
          }}
        >
        ...
        <div className="flex md:gap-6 gap-2 mr-auto absolute md:relative left-4 md:left-auto top-20 md:top-auto flex-col md:flex-row ">
        ...
        <div className="lg:w-[600px] md:w-[500px] w-[350px] absolute left-1/2-traslate-x-12  -z-10">
          ...
          <span className="xl:text-xs md:text-[10px] text-[8px] font-bold -tracking-wide absolute -top-5 xl:right-22 lg:right-26 md:right-16 right-10 rotate-[3.5deg] animate-bounce ">
            Looking for new challenges
          </span>

          <div
            className={`xl:h-[150px] h-[100px] px-3 xl:test-lg md:text-base text-xs font-light text-gray-900 dark:text-gray-200 text-justify tracking-wide overflow-y-auto transform origin-top custom-scrollbar  ${
